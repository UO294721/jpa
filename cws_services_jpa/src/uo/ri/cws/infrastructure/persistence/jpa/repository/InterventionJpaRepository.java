	...
	public List<Intervention> findByMechanicIdBetweenDates(Long id,
		...
		return Jpa.getManager()
				.createNamedQuery("Intervention.findByMechanicIdBetweenDates",
						Intervention.class)
				.setParameter(1, id).setParameter(2, startDate).setParameter(3, endDate)
				.getResultList();
	}

	@Override
	public List<Intervention> findByMechanicId(String mechanicId) {
		return Jpa.getManager()
				.createNamedQuery("Intervention.findByMechanicId", Intervention.class)

...
public class ContractTerminatePanel extends JPanel {
	...
	public ContractTerminatePanel(MainFrame parentFrame) {
	...
	private void initializeUI() {
		...
		JLabel titleLabel = new JLabel("Terminate Contract");
		...
		terminateButton.addActionListener(e -> terminateContract());
	...
	private void terminateContract() {
		...
		int confirm = JOptionPane.showConfirmDialog(this,
				"Are you sure you want to terminate contract: " + currentContract.id
						+ "?",
		...
		if (confirm == JOptionPane.YES_OPTION) {
			try {
				service.terminate(currentContract.id);
				JOptionPane.showMessageDialog(this, "Contract terminated successfully!",
						"Success", JOptionPane.INFORMATION_MESSAGE);
				parentFrame.setStatus("Contract terminated");
				currentContract = null;
				clearFields();
			} catch (Exception ex) {
				JOptionPane.showMessageDialog(this,
						"Error terminating contract: " + ex.getMessage(), "Error",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	}
